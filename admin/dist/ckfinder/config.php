...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => 'http://localhost/atherbea/userfiles/',
    'root'         => 'C:/wamp64/www/atherbea/userfiles', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
...
echo $config['pluginsDirectory'] = __DIR__ . '/plugins';
